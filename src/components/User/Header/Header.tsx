...
const HeaderSlugs = ({ to, children, onClick }: { 
  to: string, 
  ...
  return (
    <nav>
      <Link
        to={to}
        onClick={onClick}
        className="flex justify-center items-center text-primaryText text-lg font-medium hover:text-blue-hover hover:border-b-2 border-bordercol-highlight transition-all duration-300 ease-in-out"
      >
        {children}
      </Link>
    </nav>
